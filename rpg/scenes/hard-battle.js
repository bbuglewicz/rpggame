    ...
    children: [
        ...
        {gameObject: {name: "ScreenCamera", components: [{name: "ScreenCameraComponent"}],
            children: [
                ...
                {gameObject: {name: "OrcName", components: [{name: "ScreenTextComponent", args: ["Orc"]}]}, x: 1230, y: 200},
                ...
                {gameObject: {name: "MonsterHP", components: [{name: "ScreenTextComponent", args: ["50", {color: "darkgreen"}]}]}, x: 1243, y: 400}
            ]}},
        {prefabName: "player", x: -500, y: -100},
        {prefabName: "orc", x: 500, y: -100},
