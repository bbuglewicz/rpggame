    ...
    children: [
        ...
        {gameObject: {name: "ScreenCamera", components: [{name: "ScreenCameraComponent"}],
            children: [
                ...
                {gameObject: {name: "GoblinName", components: [{name: "ScreenTextComponent", args: ["Goblin"]}]}, x: 1205, y: 200},
                ...
                {gameObject: {name: "MonsterHP", components: [{name: "ScreenTextComponent", args: ["25", {color: "darkgreen"}]}]}, x: 1243, y: 400}
            ]}},
        {prefabName: "player", x: -500, y: -100},
        {prefabName: "goblin", x: 500, y: -100},
